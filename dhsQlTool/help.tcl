# $Id: help.tcl,v 1.1.1.1 2002-11-24 20:29:50 brighton Exp $
#
#***********************************************************************
...
#
# PRIVATE
# CHelp::checkPs	: Checks output from "ps" command for the
...
#
# Revision 1.2  1999/02/01 19:53:59  jaeger
...
#
# Revision 1.1  1998/07/22 18:55:38  jaeger
# Initial revision
#
...
# If we have a psId then us "ps" system call to find out if the 
...
#
# DEFICIENCIES:
# This routine may indicate that the process is running when it is
# not.  This is due to the fact that "ps" is a snapshot of what is
# running at the time the command is initiated. So the Netscape
# application could be terminated between the time it takes to check 
# for it and when the value is returned.
#-
#***********************************************************************
#
