static char rcsid[] = "$Id: stoQueue.C,v 1.2 2002-11-27 17:15:09 brighton Exp $";
//
//***********************************************************************
...
// Revision 1.1.1.1  2002/11/24 20:32:12  brighton
// Imported sources
//
...
)
{
	...
	if ( !getStopped() && status.ok() )
	{
		...
		{
		    std::cout << "execlp() failed to start mediaQueue, errno = " << 
			    errno << std::endl;
		    _exit( 999 );
		}
	    }
